		...
		<div class="container-fluid">
			...
			<div id="BookClub_AddBookForm" class="col-md-10 col-11 mx-auto px-3 py-3 mb-3 bg-white rounded-2 text-center">
				<div id="AddBook_ReturnToHome" class="d-flex align-items-center justify-content-between">
					<h2 class="fw-bold">Change Your Entry</h2>
					<a href="/book-club/books">Back to Shelves</a>
				</div>
				<form:form action="/book-club/books/${bookToEdit.id}/update" method="post" modelAttribute="bookToEdit" class="mt-2 col-lg-10 col-12 text-start">
