...
import com.codingdojo.javastack.interfaces.AnimalFunctionality;

public abstract class Animal implements AnimalFunctionality { // only one class per file
	...
	// * Abstract Class - a method without a code body
	public abstract void move(String type); // class must now be: "public abstract class Animal {}"
	
	// * IMPLEMENTED INTERFACE -----------------------
	public void eat(int energy) {
		this.energy += energy;
		System.out.printf("%s is happily eating.\n", this.name);
	}
